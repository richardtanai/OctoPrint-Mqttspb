...
port_num = 8883 
myGroupId = "SparkplugBDevices"
myNodeName = "PythonEdgeNode1"
myDeviceName = "EmulatedDevice"
publishPeriod = 5000
...
######################################################################
# The callbamqtt)k for when a PUBLISH message is received from the server.
######################################################################
...
client = paho.Client(client_id="", userdata=None, protocol=paho.MQTTv311, clean_session=True)
...
print(client.connect(serverUrl, port_num, 60))
